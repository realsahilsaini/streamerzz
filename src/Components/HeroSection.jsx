    ...
    className="pt-28 lg:pt-36">
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
        ...
        className='mt-6 space-x-4'>
          <motion.a variants={leftBtn} href="#" className='inline-block bg-blue-600 hover:bg-blue-500 text-white py-3 px-6 rounded-lg font-medium'>
            {HERO_CONTENT.callToAction.primary}
          </motion.a>
          <motion.a variants={RightBtn} href="#" className='inline-block border border-gray-500 hover:border-gray-400 text-white py-3 px-6 rounded-lg font-medium'>
