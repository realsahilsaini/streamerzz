    ...
    <section id='testimonial'>
      <div className='max-w-7xl mx-auto px-4 mt-20'>
        ...
        className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          {TESTIMONIALS_CONTENT.reviews.map((review, i) => (
            <motion.div key={i} custom={i} variants={testimonials} className='mt-10 flex flex-col items-center justify-center overflow-hidden rounded-2xl bg-neutral-900/50 border border-neutral-900 p-10'>
